...
My engineering focus sits at the intersection of **AI/ML systems**, **full stack development**, and **product thinking**. I architect end-to-end solutions — training and evaluating ML models, shipping production-grade web apps wired into LLM pipelines, real-time databases, and cloud infrastructure.
...
<img src="https://skillicons.dev/icons?i=fastapi,nodejs,firebase,supabase,postgres&theme=dark" />

**Cloud, DevOps & Tooling**

<img src="https://skillicons.dev/icons?i=gcp,aws,docker,git,vercel,vscode&theme=dark" />
...
| Performance | Random Forest Classifier with confidence scoring and feature importance |
| Security | Local inference, no PII transmitted externally |
| Impact | Real-time risk prediction with interpretable outputs for clinical use |
...
| Security | JWT-based session authentication |
...
| Impact | Live client product at bill-black-six.vercel.app |
...
| ✍️ Prompt Engineering Specialist | BE10X Certification (December 2024) |
...
[![GeeksforGeeks](https://img.shields.io/badge/GFG-Umer1444-2F8D46?style=for-the-badge&logo=geeksforgeeks&logoColor=white)](https://auth.geeksforgeeks.org/user/Umer1444)
